...
const pJS = function (e, a) {
  ...
  a && Object.deepExtend(i, a), i.tmp.obj = {
    ...
    if (this.radius = (i.particles.size.random ? Math.random() : 1) * i.particles.size.value, i.particles.size.anim.enable && (this.size_status = !1, this.vs = i.particles.size.anim.speed / 100, i.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = t ? t.x : Math.random() * i.canvas.w, this.y = t ? t.y : Math.random() * i.canvas.h, this.x > i.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > i.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), i.particles.move.bounce && i.fn.vendors.checkOverlap(this, t), this.color = {}, typeof e.value === 'object') {
      if (e.value instanceof Array) {
        const s = e.value[Math.floor(Math.random() * i.particles.color.value.length)];
      ...
      e.value == 'random'
        ...
        : typeof e.value === 'string' && (this.color = e, this.color.rgb = hexToRgb(this.color.value));
    }
    ...
    if (this.shape == 'image') {
      ...
      }, this.img.ratio || (this.img.ratio = 1), i.tmp.img_type == 'svg' && void 0 != i.tmp.source_svg && (i.fn.vendors.createSvgImg(this), i.tmp.pushing && (this.img.loaded = !1))
    }
    ...
    for (let e = 0; e < i.particles.array.length; e++) {
      ...
      if (i.particles.opacity.anim.enable && (a.opacity_status == 1 ? (a.opacity >= i.particles.opacity.value && (a.opacity_status = !1), a.opacity += a.vo) : (a.opacity <= i.particles.opacity.anim.opacity_min && (a.opacity_status = !0), a.opacity -= a.vo), a.opacity < 0 && (a.opacity = 0)), i.particles.size.anim.enable && (a.size_status == 1 ? (a.radius >= i.particles.size.value && (a.size_status = !1), a.radius += a.vs) : (a.radius <= i.particles.size.anim.size_min && (a.size_status = !0), a.radius -= a.vs), a.radius < 0 && (a.radius = 0)), i.particles.move.out_mode == 'bounce') {
        var s = {
          x_left: a.radius,
          x_right: i.canvas.w,
          y_top: a.radius,
    ...
    if (n <= i.particles.line_linked.distance) {
      const r = i.particles.line_linked.opacity - n / (1 / i.particles.line_linked.opacity) / i.particles.line_linked.distance;
      if (r > 0) {
      ...
      if (a != t) {
        if (i.tmp.bubble_duration_end) {
          if (void 0 != s) {
            ...
            const l = a - o;
            d = a + l, c == 'size' && (e.radius_bubble = d), c == 'opacity' && (e.opacity_bubble = d)
          }
          ...
          if (v != a) {
            ...
            c == 'size' && (e.radius_bubble = d), c == 'opacity' && (e.opacity_bubble = d)
          }
        } else c == 'size' && (e.radius_bubble = void 0), c == 'opacity' && (e.opacity_bubble = void 0)
      }
    }
    ...
    function a () {
      ...
      if (e.vx = u * Math.cos(a), e.vy = u * Math.sin(a), i.particles.move.out_mode == 'bounce') {
        const t = {
          x: e.x + e.vx,
          y: e.y + e.vy
        };
    ...
    if (i.interactivity.events.onhover.enable && isInArray('repulse', i.interactivity.events.onhover.mode) && i.interactivity.status == 'mousemove') {
      ...
      i.particles.move.out_mode == 'bounce' ? (v.x - e.radius > 0 && v.x + e.radius < i.canvas.w && (e.x = v.x), v.y - e.radius > 0 && v.y + e.radius < i.canvas.h && (e.y = v.y)) : (e.x = v.x, e.y = v.y)
      ...
      if (i.tmp.repulse_finish || (i.tmp.repulse_count++, i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0)), i.tmp.repulse_clicking) {
        ...
        var u = -c / m * 1;
        c >= m && a()
      } else i.tmp.repulse_clicking == 0 && (e.vx = e.vx_i, e.vy = e.vy_i)
    }
    ...
    i.interactivity.detect_on == 'window' ? i.interactivity.el = window : i.interactivity.el = i.canvas.el, (i.interactivity.events.onhover.enable || i.interactivity.events.onclick.enable) && (i.interactivity.el.addEventListener('mousemove', function (e) {
      if (i.interactivity.el == window) {
        var a = e.clientX;
        var t = e.clientY;
      } else {
        var a = e.offsetX || e.clientX;
        var t = e.offsetY || e.clientY;
      }
      ...
      if (i.interactivity.mouse.click_pos_x = i.interactivity.mouse.pos_x, i.interactivity.mouse.click_pos_y = i.interactivity.mouse.pos_y, i.interactivity.mouse.click_time = (new Date()).getTime(), i.interactivity.events.onclick.enable) {
        switch (i.interactivity.events.onclick.mode) {
          case 'push':
            i.particles.move.enable ? i.fn.modes.pushParticles(i.interactivity.modes.push.particles_nb, i.interactivity.mouse) : i.interactivity.modes.push.particles_nb == 1 ? i.fn.modes.pushParticles(i.interactivity.modes.push.particles_nb, i.interactivity.mouse) : i.interactivity.modes.push.particles_nb > 1 && i.fn.modes.pushParticles(i.interactivity.modes.push.particles_nb);
            break;
          case 'remove':
    ...
    if (i.particles.number.density.enable) {
      ...
      const a = e * i.particles.number.value / i.particles.number.density.value_area;
    ...
    if (i.tmp.img_error = void 0, i.particles.shape.image.src != '') {
      if (e == 'svg') {
        ...
        a.open('GET', i.particles.shape.image.src), a.onreadystatechange = function (e) {
          a.readyState == 4 && (a.status == 200 ? (i.tmp.source_svg = e.currentTarget.response, i.fn.vendors.checkBeforeDraw()) : (console.log('Error pJS - Image not found'), i.tmp.img_error = !0))
        }, a.send()
      } else {
        const t = new Image();
    ...
    i.particles.shape.type == 'image' ? i.tmp.img_type == 'svg' ? i.tmp.count_svg >= i.particles.number.value ? (i.fn.particlesDraw(), i.particles.move.enable ? i.fn.drawAnimFrame = requestAnimFrame(i.fn.vendors.draw) : cancelRequestAnimFrame(i.fn.drawAnimFrame)) : i.tmp.img_error || (i.fn.drawAnimFrame = requestAnimFrame(i.fn.vendors.draw)) : void 0 != i.tmp.img_obj ? (i.fn.particlesDraw(), i.particles.move.enable ? i.fn.drawAnimFrame = requestAnimFrame(i.fn.vendors.draw) : cancelRequestAnimFrame(i.fn.drawAnimFrame)) : i.tmp.img_error || (i.fn.drawAnimFrame = requestAnimFrame(i.fn.vendors.draw)) : (i.fn.particlesDraw(), i.particles.move.enable ? i.fn.drawAnimFrame = requestAnimFrame(i.fn.vendors.draw) : cancelRequestAnimFrame(i.fn.drawAnimFrame))
  }, i.fn.vendors.checkBeforeDraw = function () {
    i.particles.shape.type == 'image' ? i.tmp.img_type == 'svg' && void 0 == i.tmp.source_svg ? i.tmp.checkAnimFrame = requestAnimFrame(check) : (cancelRequestAnimFrame(i.tmp.checkAnimFrame), i.tmp.img_error || (i.fn.vendors.init(), i.fn.vendors.draw())) : (i.fn.vendors.init(), i.fn.vendors.draw())
...
Object.deepExtend = function (e, a) {
  for (const t in a) a[t] && a[t].constructor && a[t].constructor === Object ? (e[t] = e[t] || {}, arguments.callee(e[t], a[t])) : e[t] = a[t];
  return e
