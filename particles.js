...
const pJS = function (TagId, params) {
  const CanvasEl = document.querySelector('#' + TagId + ' > .particles-js-canvas-el');
    ...
    switch (p.shape) {
      ...
      case 'image':
        ...
        if (pJS.tmp.img_type === 'svg') {
          var ImgObj = p.img.obj;
        } else {
          var ImgObj = pJS.tmp.ImgObj;
        }
...
window.particlesJS = function (TagId, params) {
  ...
  /* pJS elements */
  const pJS_tag = document.getElementById(TagId);
  ...
  CanvasEl.className = pJS_canvas_class;
